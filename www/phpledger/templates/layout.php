...
<?php if ($accountReturn): ?><a class="btn btn-ghost my-3" href="<?= pl_e(pl_url('/reports/account',$accountReturn)) ?>"><?= pl_icon('arrow-left') ?> Back to account statement</a><?php endif; ?>
