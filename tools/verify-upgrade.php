...
try {
    ...
    if ($migration['applied'] !== ['002_product_slice', '003_demo_isolation', '004_pos_showcase', '005_demo_period_guard', '006_core_accounts_journals', '006_opening_cutover', '007_period_administration', '008_bank_reconciliation', '009_bank_draft_cancellation'] || $migration['skipped'] !== ['001_foundation']) {
    ...
    echo "Upgrade passed: original 001 -> complete core/opening/period/bank chain, preserved six accounts and posted journal/lines, required review, explicit role mapping, reconciled report, replay and UTC session.\n";
} finally {
