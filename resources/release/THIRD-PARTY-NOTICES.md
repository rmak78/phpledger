...
| Tabler icons | Existing icons at commit `55f87a73f45cf1d9eaf16d7da705065483a9e4f9`, additional interface icons from `@tabler/icons` 3.46.0; https://github.com/tabler/tabler-icons | MIT; `www/phpledger/public/assets/icons/LICENSE.txt` and `SOURCE.txt`. |
