...
These files target the PHP Ledger **0.2.0-preview candidate**, not the published 0.1.5 demo. Replace example URLs/IDs and absolute paths. No exported file contains credentials. Keep populated private client settings out of source control and exported workflows.
