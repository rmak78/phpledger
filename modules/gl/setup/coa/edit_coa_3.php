...
<div class="form-group">
	<label class="col-md-3 col-sm-3 control-label">Account Code:</label>
		...
		<div class="input-group">
          ...
          <input required="reqired" type="text" name="account_code" class="masked form-control" data-inputmask="'mask': '<?php echo $mask;?>'" data-autoclear="true" 
		  placeholder="<?php echo $placeholder;?>" value="<?php echo $account_code;?>" / >
          </div><!-- /.input group -->
...
<div class="form-group">
	<label class="col-md-3 col-sm-3 control-label">Short Description:</label>
		...
		<div class="input-group">
          ...
          <input type="text" name="account_desc_short" class="form-control" required="required" value="<?php echo $account_desc_short;?>" />
          </div><!-- /.input group -->
