...
- [Upstream chart mirror](../../resources/coa/upstream/README.md): 260 Odoo 19.0 / ERPNext v16 country charts normalised to PHP Ledger types with role defaults and provenance. Per decision B8 (18 September 2026) country packages are authored from this mirror and the candidate lists above are superseded for chart selection.
