...
Decision adopted 15 September 2026: serve **sales-tax-registered SMEs, sole traders, AOPs and Pvt Ltd companies in Pakistan first**. The buyer and desktop operator is often an accountant, tax consultant or software house maintaining books for several clients. The owner at the counter is phone-first. The informal kiryana tier is not the target segment. Maintain explicit per-client company/book permissions and readable daily workflows backed by traceable double-entry records; no claim of FBR compliance is made by selecting that audience.
...
Regional expansion after Pakistan is **UAE, Saudi Arabia, Oman; then Singapore, Malaysia, Sri Lanka and Bangladesh**. Each jurisdiction needs its own current research, entity scope and accounting/tax review. Earlier UK research remains reference material, not the next delivery priority.
