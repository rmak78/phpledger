...
The current POS is a cash-sale showcase retained in the 0.1.4-preview package and hosted demo, using six fictional products. It demonstrates how a simple shop transaction reaches the same accounting records as other receipts. Click-to-add product tiles and a separate review/cash screen are included.
