...
- Backup restoration passed for **34 table definitions/data checksums, 32,711 synthetic rows, 35 guards and twelve receipts**, with balanced journals and scoped source links. Only the generated restoration database was removed. Exact candidate-package fresh install/0.1.4 upgrade remains to be recorded.
