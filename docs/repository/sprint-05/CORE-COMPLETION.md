...
| Core HTTP | 72 assertions, 0 failures, no skipped viewer checks; chart/general draft/post/reverse, stale/conflict/CSRF/scope/permission behavior. Synthetic company 19 retained. |
| Opening/period/bank HTTP | 71 assertions, 0 failures; synthetic company 15, cancelled statement 7 and completed statement 8 retained. |
