...
|---|---|
| GitHub source and README | Default branch updated; repository description now reflects the core-first scope. [CI run 34911987945](https://github.com/rmak78/phpledger/actions/runs/34911987945) completed successfully for the exact package source. |
| Download | [v0.1.2-preview](https://github.com/rmak78/phpledger/releases/tag/v0.1.2-preview) published as a prerelease with ZIP and checksum. **1,276,132 bytes; 123 manifest files plus the manifest**. Repeated builds are byte-identical; a fresh download from GitHub matches the local ZIP. |
...
| Wiki | [Wiki](https://github.com/rmak78/phpledger/wiki) commit **`b14b9a691cf162ac79e484c297d3a58f92738a48`**. Thirteen files changed/added; all fourteen Markdown files match the reviewed source. All twelve content pages and Wiki home returned 200 with current scope and navigation. |
