...
- Final PHP 8.2 check after the playground and capacity fixes: 225 tests, zero failures; 168 PHP files linted and static analysis clean. Restricted-demo HTTP entry, partial receipts, DEMO5 bill/invoice and partial payments passed. Expected balances were AR 27.50, AP 32.50 and three stock items valued at 30.00. Final PHP 8.3 and exact ZIP installation/upgrade results are recorded by the release receipt.
