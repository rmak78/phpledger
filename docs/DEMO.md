...
The accounting starter adds an explicit **Accounting starter playground** choice alongside the four historical companies. Private provisioning creates a zero-balance practice company in the current year, activates Purchasing and Inventory, prepares control accounts, a synthetic customer/vendor, a stock product and a clearly illustrative manual tax code. It posts no historical/opening balance. The existing four historical pack files remain unchanged.
