...
test('core-only companies post report export and reverse with every optional module disabled', function (): void {
    ...
    pl_reverse_general_draft($f['actor_id'], $f['company_id'], $f['book_id'], $draft['id'], '2026-09-15', 'Synthetic core-only correction');
...
test('module enable disable and reenable retain POS sources exact receipts and accounting corrections', function (): void {
    ...
    pl_reverse_document($f['actor_id'], $f['company_id'], $f['book_id'], $sale['document_id'], '2026-09-15', 'Synthetic full-sale correction');
