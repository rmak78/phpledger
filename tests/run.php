...
$suites = ['auth_test.php', 'ledger_test.php', 'concurrency_test.php', 'document_test.php', 'regional_test.php', 'report_test.php', 'pos_test.php', 'opening_test.php', 'period_test.php', 'reconciliation_test.php', 'installer_test.php'];
